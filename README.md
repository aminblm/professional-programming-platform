...
> Tweet/ Thread for the full story behind [aminblm/professional-programming-platform](https://x.com/aminblm/status/1808643945141821560).

The following list has been compiled by [charlax/professional-programming](https://github.com/charlax/professional-programming) and the platform will follow the coding guidelines mentioned in it.
